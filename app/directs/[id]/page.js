                  ...
                  <div className="relative w-full max-w-[78%]">
                    ...
                    >
                      ...
                      >
                        ...
                        />
                        <div className="absolute inset-x-0 bottom-0 z-20 bg-gradient-to-t from-black/88 via-black/46 via-48% to-transparent px-3 py-2 text-white pointer-events-none flex h-[38%] flex-col justify-end gap-0.5">
