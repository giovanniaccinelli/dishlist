  ...
  if (row.type === "map") {
    return (
      <section className="explore-row no-accent-border mb-6 shadow-none">
        ...
        <div
          className={`no-accent-border relative block ${fullMap ? "h-[clamp(10rem,calc(100dvh-var(--app-top-nav-offset)-var(--app-bottom-nav-height)-15rem),18rem)]" : "h-[7.25rem]"} w-full overflow-hidden rounded-[1.35rem] border text-left shadow-[0_12px_28px_rgba(0,0,0,0.12)] ${
