...
function LeaderboardRail({ questions = [], t, darkMode = false }) {
  ...
  return (
    <section className="mb-7">
      ...
      <div className="flex gap-3 overflow-x-auto pb-3 pl-6 pr-4 pt-1 snap-x snap-mandatory scroll-pl-6 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
