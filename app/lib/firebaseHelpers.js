...
function buildDishPayload(dishId, dishData = null) {
  return dishData
    ? {
        ...
        mediaItems: Array.isArray(dishData.mediaItems) ? dishData.mediaItems : [],
...
async function hydrateDishPayload(dishId, payload) {
  try {
    ...
    return {
      ...
      mediaItems: Array.isArray(data.mediaItems) ? data.mediaItems : Array.isArray(payload?.mediaItems) ? payload.mediaItems : [],
...
async function mergeDishesWithCanonical(dishes = []) {
  ...
  return items.map((dish) => {
    ...
    return {
      ...
      mediaItems: Array.isArray(canonical.mediaItems) ? canonical.mediaItems : Array.isArray(dish.mediaItems) ? dish.mediaItems : [],
