...
function ClinkingGlassesIcon({ className = "" }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
      <path d="M7.1 4.8h4.4L10.8 9a3 3 0 0 1-3 .1L7.1 4.8Z" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round" />
      <path d="M12.5 4.8h4.4l-.7 4.3a3 3 0 0 1-3-.1l-.7-4.2Z" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round" />
...
function ChiliIcon({ className = "" }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
      <path d="M6.2 15.9c0-4.5 3.1-7.4 7.5-7.4 1.3 0 2.5.3 3.6.9-.2 5.4-3.8 9.3-8.8 9.3-1.5 0-2.3-1.1-2.3-2.8Z" fill="currentColor" fillOpacity="0.12" stroke="currentColor" strokeWidth="1.95" strokeLinejoin="round" />
