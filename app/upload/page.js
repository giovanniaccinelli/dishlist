              ...
              <>
                ...
                {true ? (
                  ...
                  >
                    ...
                    >
                      <div className="grid min-h-[2.6rem] grid-cols-[2.25rem,1fr] items-center gap-2.5">
                        <span className={`inline-flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-[0.8rem] ${dishMode === DISH_MODE_RESTAURANT ? "restaurant-accent-border border-2 bg-[#FFE2E2] text-[#E64646]" : "border border-[#E64646]/45 bg-[#2A1111] text-[#E64646]"}`}>
