...
const translations = {
  ...
  it: {
    ...
    "Directs, comments, and new dishes when they matter.": "Direct, commenti e nuovi piatti quando contano.",
    "If you have not already, update the app first.": "Se non l'hai già fatto, aggiorna prima l'app.",
    "Turn on": "Attiva",
    "Not now": "Non ora",
    ...
    "Add dishes": "Aggiungi piatti",
    "Dishes added": "Piatti aggiunti",
    "New Dishlist": "Nuova dishlist",
    "Name it": "Dai un nome",
    "Popular names": "Nomi popolari",
    Next: "Avanti",
    Create: "Crea",
    "Creating...": "Creazione...",
    "Search your dishes": "Cerca nei tuoi piatti",
    "No matching dishes.": "Nessun piatto trovato.",
    "Search results": "Risultati ricerca",
    "Just swiped": "Salvato",
    Salvato: "Salvato",
    "Scegli dishlist": "Scegli dishlist",
    "Loading dishlists...": "Caricamento dishlists...",
    "No dishlists yet.": "Nessuna dishlist.",
    "selected singular": "selezionato",
    "selected plural": "selezionati",
    "Lo sto mangiando": "Lo sto mangiando",
    "Publish to stories too": "Pubblica anche nelle storie",
    ...
    "Dishlist cover": "Copertina dishlist",
    ...
    "No matching dishes.": "Nessun piatto trovato.",
    "Search dishes": "Cerca piatti",
    "Search dishes or filters": "Cerca piatti o filtri",
    "Search dishes...": "Cerca piatti...",
    "Top picks": "Preferiti",
    Favorites: "I tuoi classici",
    "Your Classics": "Classici",
    "To Try": "Da provare",
    "All dishes": "Tutti",
    Dishes: "Piatti",
    Directs: "Messaggi",
    "Sign in to view directs": "Accedi per vedere i messaggi",
    "Sign in to message": "Accedi per scrivere",
    "No conversations yet.": "Ancora nessuna conversazione.",
    "Shared a dish": "Ha condiviso un piatto",
    "Message...": "Messaggio...",
    Chat: "Chat",
    Online: "Online",
    Active: "Attivo",
    "Active recently": "Attivo di recente",
    Sent: "Inviato",
    Read: "Letto",
    ...
    "Create dish": "Carica",
    "Upload dish": "Carica",
    "Public dish": "Piatto pubblico",
    "Visible in feed": "Visibile nel feed",
    "Hidden from feed": "Nascosto dal feed",
    ...
    "Story views": "Visualizzazioni storia",
    "Seen by": "Vista da",
    "Close story views": "Chiudi visualizzazioni storia",
    "Nobody has viewed this story yet.": "Nessuno ha ancora visto questa storia.",
    User: "Utente",
    "Just now": "Ora",
    Story: "Storia",
    "Be the first to comment": "Commenta per primo",
    More: "Altro",
    Comments: "Commenti",
    ...
    "Delete Dishlist": "Elimina dishlist",
    "This removes the dishlist itself, but keeps the dishes in your profile.": "Elimina la dishlist, ma lascia i piatti nel tuo profilo.",
    Edit: "Modifica",
