          ...
          >
            ...
            {currentCardIsRestaurant && currentRestaurantPlaceId && currentRestaurantLabel ? (
              <button
                ...
                className="no-accent-border max-w-[13.5rem] truncate rounded-full border border-[#E64646]/18 bg-[rgba(35,12,12,0.76)] px-3.5 py-[0.42rem] text-[12px] font-semibold leading-none text-white shadow-[0_10px_24px_rgba(0,0,0,0.28),inset_0_1px_0_rgba(255,255,255,0.08)] backdrop-blur-[10px] transition active:scale-[0.98]"
